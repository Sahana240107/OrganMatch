...
const { createRecipient, getRecipients, getWaitingList, updateUrgency } = require('../controllers/recipient.controller');
const { validate, recipientSchema } = require('../middleware/validate.middleware');
const { auditLog } = require('../middleware/audit.middleware');

router.get('/',               getRecipients);       // ← NEW — what Recipients page calls
