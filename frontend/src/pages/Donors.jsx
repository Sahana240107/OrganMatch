                  ...
                  {donors.map(d => {
                    ...
                    return (
                      <tr key={d.donor_id}>
                        ...
                        <td>
                          <span className={`badge ${d.donor_type === 'deceased' ? 'badge-red' : 'badge-blue'}`}>
                            {d.donor_type === 'deceased' ? 'Deceased' : 'Living'}
                          </span>
                        </td>
                        <td>{d.age} / {d.sex}</td>
                        ...
                        <td>
                          <div className="flex gap-4" style={{ flexWrap: 'wrap' }}>
                            {(d.organs || []).map(o => <OrganPill key={o.organ_id} type={o.organ_type} />)}
                            {!d.organs?.length && <span className="text-muted" style={{ fontSize: 11 }}>—</span>}
                          </div>
                        </td>
                        ...
                        <td>
                          {d.status === 'active' && (
                            <button
                              ...
                              onClick={() => handleWithdraw(d.donor_id)}
                            >
                              Withdraw
                            </button>
                          )}
