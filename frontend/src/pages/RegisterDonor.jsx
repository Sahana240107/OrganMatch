...
export default function RegisterDonor() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setError(e.message || 'Failed to register donor.')
    }
  }
    ...
    <div>
      <div className="page-header mb-24">
        <div>
          ...
          <p className="page-subtitle">Complete all 5 steps to register a donor — matching triggers automatically on organ entry</p>
        </div>
      </div>
              ...
              <div style={{ padding: 16 }}>
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input className="form-control" placeholder="As per Aadhaar"
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input className="form-control" type="number" placeholder="Years"
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <select className="form-control" value={form.hospital_id} onChange={e => set('hospital_id', e.target.value)}>
                      <option value="">
                        {hospitals.length === 0 ? 'Loading…' : 'Select hospital'}
                      </option>
                      {hospitals.map(h => (
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input className="form-control" type="number" placeholder="72"
                      value={form.weight_kg} onChange={e => set('weight_kg', e.target.value)} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Height (cm)</label>
                    <input className="form-control" type="number" placeholder="172"
                ...
                <div className="form-group">
                  <label className="form-label">Brain Death Time</label>
                  <input className="form-control" type="datetime-local"
                    value={form.brain_death_time} onChange={e => set('brain_death_time', e.target.value)} />
                </div>
              </div>
            </div>
          )}
              ...
              <div style={{ padding: 16 }}>
                <div className="form-group">
                  ...
                  <textarea className="form-control" rows={4}
                    placeholder="Relevant conditions, medications, allergies…"
                    value={form.medical_history} onChange={e => set('medical_history', e.target.value)} />
                </div>
                <div className="form-group">
                  <label className="form-label">Consent Document Reference</label>
                  <input className="form-control" placeholder="e.g. consent_2041.pdf"
                    value={form.consent_document} onChange={e => set('consent_document', e.target.value)} />
                </div>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div style={{ padding: 16 }}>
                <div style={{ fontSize: 12, color: 'var(--text2)', marginBottom: 12 }}>
                  Select all organs available for donation
                </div>
                <OrganSelector selected={organs} onChange={setOrgans} />
                {organs.length > 0 && (
                  <div style={{ marginTop: 16, padding: 12, background: 'rgba(22,163,74,0.06)', borderRadius: 8, border: '1px solid rgba(22,163,74,0.2)' }}>
              ...
              <div style={{ padding: 16 }}>
                ...
                <div style={{ background: 'var(--bg3)', borderRadius: 8, padding: 12, fontSize: 12, marginBottom: 16 }}>
                  ...
                  <div className="flex justify-between mb-8">
                    ...
                    <span>{hospitals.find(h => String(h.hospital_id) === String(form.hospital_id))?.name || '—'}</span>
                  </div>
